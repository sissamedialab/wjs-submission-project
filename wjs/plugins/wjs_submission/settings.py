...
DEFAULT_HIERARCHICAL_KEYWORDS_JOURNALS = ["JHEP", "JCAP", "JSTAT", "JINST", "JQuant"]
...
KEYWORD_FILTERS = getattr(settings, "SUBMISSION_KEYWORD_FILTERS", DEFAULT_KEYWORD_FILTERS)
HIERARCHICAL_KEYWORDS_JOURNALS = getattr(
    settings, "SUBMISSION_HIERARCHICAL_KEYWORDS_JOURNALS", DEFAULT_HIERARCHICAL_KEYWORDS_JOURNALS
)
...
DEFAULT_IOP_JOURNALS = ["JCAP"]

IOP_JOURNALS = getattr(settings, "SUBMISSION_IOP_JOURNALS", DEFAULT_IOP_JOURNALS)
